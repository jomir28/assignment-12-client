...
const TableRow = ({ withdraw,refetch }) => {
    ...
    const handlePaymentSuccess = async(id,email) => {
        ...
        const result = await axiosSecure.patch(`/user-coin-deducted/${email}`, { withdraw: withdraw.coin_to_withdraw })
        // console.log(result);
    ...
    return (
        <tr>
                ...
                <div className="flex items-center gap-3">
                    <div className="avatar">
                        <div className="mask mask-squircle w-12 h-12">
                            <img src={withdraw.worker_image} alt="Avatar Tailwind CSS Component" />
                        </div>
                    </div>
                    <div>
            ...
            <td>{timeString}</td>
            <th>
                <button onClick={()=>handlePaymentSuccess(withdraw._id,withdraw.worker_email)} className="btn btn-primary btn-xs">Payment Success</button>
            </th>
