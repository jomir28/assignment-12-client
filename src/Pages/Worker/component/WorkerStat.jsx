            ...
            <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:py-4 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 mt-4">
                    ...
                    <div className="bg-white overflow-hidden shadow sm:rounded-lg">
                        <div className="px-4 py-5 sm:p-6">
                            <dl>
                                <dt className="text-sm leading-5 font-medium  truncate text-gray-400">Total Submission</dt>
                                <dd className="mt-1 text-3xl leading-9 font-semibold  text-indigo-400">{state.total_submission}
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div className="bg-white overflow-hidden shadow sm:rounded-lg">
                        <div className="px-4 py-5 sm:p-6">
                            <dl>
                                <dt className="text-sm leading-5 font-medium  truncate text-gray-400"> Total Earning
                                </dt>
