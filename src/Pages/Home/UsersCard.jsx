...
const UsersCard = () => {
    ...
    return (
        ...
        <div className="bg-gray-100">
            <h3 className="text-3xl font-bold text-center  underline">Our Top Earners</h3>
            <div className="container mx-auto py-6  grid grid-cols-1 px-4 md:grid-cols-2 gap-8 lg:grid-cols-3">
                {
                    topUsers.map(user => <div key={user?._id} className="w-full py-1 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
