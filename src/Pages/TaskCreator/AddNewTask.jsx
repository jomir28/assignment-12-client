            ...
            <form onSubmit={handleTaskSubmit} className="lg:max-w-5xl h-full mx-auto pt-10">
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input name="task_title" type="text" id="task_title" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Task Title" required />
                    </div>
                    <div>
                        <label htmlFor="task_detail" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Task Detail</label>
                        <input name="task_detail" type="text" id="task_detail" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" Your Task Detail" required />
                    </div>
                    <div>
                        <label htmlFor="task_quantity" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Task Quantity</label>
                        <input name="task_quantity" type="text" id="task_quantity" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Task Quantity" required />
                    </div>
                    <div>
